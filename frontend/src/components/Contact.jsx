...
export default function Contact() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`https://seoplanet-seoplanet-backend.hf.space/api/contact`, {
        name: form.name,
        email: form.email,
  ...
  const onBookingSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`https://seoplanet-seoplanet-backend.hf.space/api/contact`, {
        name: booking.name,
        email: booking.email,
