            ...
            <tr><td align="center">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;margin:0 auto;background:#0A0A0F;border-radius:16px;overflow:hidden;border:1px solid #1F1F2E;box-shadow:0 20px 40px rgba(0,0,0,0.8), 0 0 20px rgba(0,255,148,0.05);">
                ...
                <tr><td style="padding:48px;text-align:left;">
                  <p style="color:#ffffff;font-size:16px;line-height:1.8;margin:0 0 24px 0;font-weight:300;">
                  ...
                  <p style="color:#ffffff;font-size:15px;line-height:1.6;margin:0 0 32px 0;font-weight:300;">
